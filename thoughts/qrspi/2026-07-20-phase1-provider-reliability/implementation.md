...
- `python3 -m pytest tests/test_provider_reliability.py tests/test_anthropic_streaming_contract.py tests/test_proxy_routing.py tests/test_interceptor_contract.py` — passed, 20 tests.
- `python3 -m pytest tests` — passed, 38 tests.
