...
/** Patterns that enable sandbox escapes or host access. */
export const DANGEROUS_SOURCE =
  /\b(require|process|globalThis|global|Function|eval|import|export|child_process|fs|net|http|https|vm|worker_threads|worker_thread|WebAssembly|Reflect|Proxy|constructor|__proto__|module\.exports|Buffer|setImmediate|setInterval|setTimeout)\b|[\u2028\u2029]|\\u00/i;
